...
/**
 * Created by deadlydragger on 1/4/19.
 */

public class MgPreAuthCancelletionEmvAPI extends AsyncTask<String, String, SoapObject> {
    ...
    public MgPreAuthCancelletionEmvAPI(Context context, String authCode , String emvPayload, String txnAmt, String pBlock, ResponseInterface responseInterface) {
...
//                tellersDbHelper.deletTrace(crrn);
    ...
    private static SoapObject getWS(TellersDbHelper tellersDbHelper, String stan, String crrn, String authCode, String track2, String txnAmt, String pBlock) throws IOException, XmlPullParserException {
        final String SOAP_ACTION = "http://tempuri.org/ISoftNacService/PreAuthCancelletionMag";
        final String OPERATION_NAME = "PreAuthCancelletionMag";
        ...
        tellersDbHelper.insertTrace(new Tracemodule(stan, crrn, "preAuthCancel",  PrefUtil.getCardNo(), txnAmt, "0"));
