...
public class ReverseTxnEmvAPI extends AsyncTask<String, String, SoapObject> {
...
//    private String stan, crrn;
    ...
    public ReverseTxnEmvAPI(Context context, Tracemodule tracemodule, ResponseInterface responseInterface) {
...
//                tellersDbHelper.deletTrace(crrn);
    ...
    private static SoapObject getWS(TellersDbHelper tellersDbHelper, Tracemodule tracemodule/*, String stan, String crrn*/) throws IOException, XmlPullParserException {
        final String SOAP_ACTION = "http://tempuri.org/ISoftNacService/ReverseTxnEmv";
        final String OPERATION_NAME = "ReverseTxnEmv";
