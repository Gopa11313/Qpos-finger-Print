...
public class PreAuthCancelletionEmvAPI extends AsyncTask<String, String, SoapObject> {
    ...
    public PreAuthCancelletionEmvAPI(Context context, String authCode , String emvPayload, String txnAmt, String pBlock, ResponseInterface responseInterface) {
...
//                tellersDbHelper.deletTrace(crrn);
    ...
    private static SoapObject getWS(TellersDbHelper tellersDbHelper, String stan, String crrn, String authCode, String emvPayload, String txnAmt, String pBlock) throws IOException, XmlPullParserException {
        final String SOAP_ACTION = "http://tempuri.org/ISoftNacService/PreAuthCancelletionEmv";
        final String OPERATION_NAME = "PreAuthCancelletionEmv";
...
//            string="0";
        ...
        tellersDbHelper.insertTrace(new Tracemodule(stan, crrn, "preAuthCancel", emvPayload, txnAmt, "0"));
