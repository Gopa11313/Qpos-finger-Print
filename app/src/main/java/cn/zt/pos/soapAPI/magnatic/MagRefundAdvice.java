...
public class MagRefundAdvice extends AsyncTask<String, String, SoapObject> {
    ...
    public MagRefundAdvice(Context context, String de38, String oCrrn, String track2, String txnAmt, String pBlock, ResponseInterface responseInterface) {
...
//                tellersDbHelper.deletTrace(crrn);
    ...
    private static SoapObject getWS(TellersDbHelper tellersDbHelper, String stan, String crrn, String de38, String refNo, String track2, String txnAmt, String pBlock) throws IOException, XmlPullParserException {
        final String SOAP_ACTION = "http://tempuri.org/ISoftNacService/MagRefundAdvice";
        final String OPERATION_NAME = "MagRefundAdvice";
...
//            string="0";
        ...
        tellersDbHelper.insertTrace(new Tracemodule(stan, crrn, "voidTxnE",track2, txnAmt, "0"));
    ...
    private  static String dateConvert(){
        ...
        String date = null;
        try {
            date = sdf.format((new SimpleDateFormat("yyyyMMdd")).parse(daten + calendar.getTime()));
