...
public class PreAuthCompAdviceMag extends AsyncTask<String, String, SoapObject> {
    ...
    public PreAuthCompAdviceMag(Context context, String authCode , String emvPayload, String txnAmt, String pBlock, ResponseInterface responseInterface) {
...
//                tellersDbHelper.deletTrace(crrn);
    ...
    private static SoapObject getWS(TellersDbHelper tellersDbHelper, String stan, String crrn, String authCode, String emvPayload, String txnAmt, String pBlock) throws IOException, XmlPullParserException {
        final String SOAP_ACTION = "http://tempuri.org/ISoftNacService/PreAuthCompAdviceMag";
        final String OPERATION_NAME = "PreAuthCompAdviceMag";
        ...
        Log.d("dinesh", "getWS: PreAuthCompAdviceMag" + request.toString());
