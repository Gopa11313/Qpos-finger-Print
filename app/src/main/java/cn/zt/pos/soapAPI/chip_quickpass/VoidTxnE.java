...
public class VoidTxnE extends AsyncTask<String, String, SoapObject> {
    ...
    public VoidTxnE(Context context, String de38, String oCrrn, String emvPayload, String txnAmt, String pBlock, ResponseInterface responseInterface) {
    ...
    protected SoapObject doInBackground(String... strings) {
        try {
            return getWS(tellersDbHelper, stan, crrn,de38, oCrrn, emvPayload, txnAmt, pBlock);
        } catch (IOException e) {
            e.printStackTrace();
        } catch (Exception e) {
            e.printStackTrace();
...
//                tellersDbHelper.deletTrace(crrn);
    ...
    private static SoapObject getWS(TellersDbHelper tellersDbHelper, String stan, String crrn, String de38, String refNo, String emvPayload, String txnAmt, String pBlock) throws IOException, XmlPullParserException {
        final String SOAP_ACTION = "http://tempuri.org/ISoftNacService/VoidTxnE";
        final String OPERATION_NAME = "VoidTxnE";
