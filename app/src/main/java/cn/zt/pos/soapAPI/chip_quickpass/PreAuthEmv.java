...
public class PreAuthEmv extends AsyncTask<String, String, SoapObject> {
    ...
    public PreAuthEmv(Context context, String emvPayload, String txnAmt, String pBlock, ResponseInterface responseInterface) {
...
//                tellersDbHelper.deletTrace(crrn);
    ...
    private static SoapObject getWS(TellersDbHelper tellersDbHelper, String stan, String crrn, String emvPayload, String txnAmt, String pBlock) throws IOException, XmlPullParserException {

        final String SOAP_ACTION = "http://tempuri.org/ISoftNacService/PreAuthEmv";

        final String OPERATION_NAME = "PreAuthEmv";
...
//            string="0";
        ...
        Log.d("dinesh", stan + "/" + crrn);
        tellersDbHelper.insertTrace(new Tracemodule(stan, crrn, "preAuth", emvPayload, txnAmt, "0"));

        SoapSerializationEnvelope envelope = new SoapSerializationEnvelope(
                SoapEnvelope.VER11);
        envelope.dotNet = true;
        envelope.setOutputSoapObject(request);
        HttpTransportSE httpTransport = new HttpTransportSE(SOAP_ADDRESS, 45000);
