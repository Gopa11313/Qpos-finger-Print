...
public class MgCheckTxnStatusAPI extends AsyncTask<String, String, SoapObject> {
    ...
    public MgCheckTxnStatusAPI(Context context, String txnAmt, String stan, String crrn, ResponseInterface responseInterface) {
    ...
    protected void onPostExecute(SoapObject s) {
        ...
        try {
            PrefUtil.setpaidAmount("0");
            PrefUtil.setdisAmount("0");
            String TAG="dinesh";
            ...
            if (object.getString("respCode").equals("LO") && count < 10) {
            ...
            } else if (object.getString("respCode").equals("00")) {
...
//                    PrefUtil.sett72(tag72);
//                    PrefUtil.sett91(tag91);
//                    PrefUtil.sett55(tag55);
                ...
                if (Double.valueOf(object.getString("disAmount"))>0){
                    ...
                    responseInterface.loginSuccess(object.getString("respCode"), tag38, tag55, tag91, "", tag72);
                }
